# Looker Extension dashboard-reviewer

dashboard-reviewer is a Looker extension using React and JavaScript.
...
5. Create a `manifest` file
   ...
   ```
    project_name: "dashboard-reviewer"
    application: dashboard-reviewer {
        label: "dashboard-reviewer React/JavaScript extension"
